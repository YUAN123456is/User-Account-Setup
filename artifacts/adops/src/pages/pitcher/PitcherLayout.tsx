...
import { LayoutDashboard, CreditCard, BarChart3, UserCheck, MessageSquare, Facebook, Wallet, TicketIcon } from "lucide-react";
...
export default function PitcherLayout({ children }: { children: ReactNode }) {
  ...
  const items = [
    ...
    { label: "提交工单", href: "/pitcher/tickets", icon: TicketIcon },
