...
import {
  CheckCircle2, Clock, Ticket, ChevronDown, ChevronUp,
  RefreshCw, Search, CalendarDays, X, LayoutDashboard,
  User, BarChart2, Settings,
} from "lucide-react";
...
const HISTORY = [
  { id: 1, type: "new_account", typeLabel: "开新户", provider: "开户商 - 小王", status: "completed", date: "2026-05-10", summary: "FB · $500",  completedNote: "账户 act_12345678" },
  { id: 2, type: "rebind_bm",   typeLabel: "换绑 BM", provider: "开户商 - 晓敏", status: "pending",   date: "2026-05-12", summary: "BM_002",       completedNote: null },
  { id: 3, type: "new_account", typeLabel: "开新户", provider: "开户商 - 张总", status: "pending",   date: "2026-05-13", summary: "GG · $1000",  completedNote: null },
  { id: 4, type: "rebind_bm",   typeLabel: "换绑 BM", provider: "开户商 - 小王", status: "completed", date: "2026-05-08", summary: "BM_003",       completedNote: "已处理" },
  { id: 5, type: "new_account", typeLabel: "开新户", provider: "开户商 - 晓敏", status: "completed", date: "2026-05-06", summary: "TT · $800",   completedNote: "账户 act_55667788" },
];
  ...
  const handleSubmit = () => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        setPlatform(""); setAmount(""); setNewRemark("");
        setTargetBm(""); setAccount(""); setRebindRemark("");
      }, 1500);
    }, 800);
  };

  const canSubmit = provider && ticketType && !submitting;

  return (
    <div className="min-h-screen bg-background text-foreground flex h-screen">
      {/* ── Sidebar ── */}
      <div className="w-52 border-r border-border bg-card flex flex-col py-4 px-3 gap-0.5 shrink-0">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-5">
        ...
        <div>
          <h1 className="text-xl font-bold flex items-center gap-2">
            <Ticket className="h-5 w-5 text-primary" />工单管理
          </h1>
            ...
            <div className="flex gap-3">
              {[{ value: "new_account", label: "开新户" }, { value: "rebind_bm", label: "换绑 BM" }].map(t => (
                <button
                  ...
                  className={[
                    "w-32 rounded-lg border-2 py-2.5 text-sm font-medium transition-all",
                    ticketType === t.value
                ...
                <TableBody>
                  ...
                  {filtered.map(t => (
                    <TableRow key={t.id} className="text-sm">
                      ...
                      <TableCell className="text-muted-foreground text-xs">{t.summary}</TableCell>
